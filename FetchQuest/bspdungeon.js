...
export default class BSPDungeon {
    ...
    goDown() {
        if (this.currentLevel < this.levels.length - 1) {
            ...
            console.error("You can't go down, you're already at the bottom of the dungeon.")
        }
    }
    ...
    goUp() {
        if (this.currentLevel > 0) {
            ...
            console.error("You can't go up, you're already at top of the dungeon.")
        }
    }
...
class BSPLevel {
    ...
    addStairs() {
        // Place stairs down in the room at the right-most tree node. 
        ...
        // Place stairs up in the room at the left-most tree node. 
        node = this.tree.left
